function HeroSection (){
    return (
        <section className="px-container-margin py-lg flex flex-col md:flex-row gap-lg mt-sm md:mt-lg items-center max-w-7xl mx-auto" id="hero">
          <div className="flex flex-col gap-sm md:w-1/2 text-left items-start">
            ...
            <p className="font-body-md md:font-body-lg md:text-body-lg text-body-md text-on-surface-variant mt-sm fade-in-up-element stagger-3">
              Simplify shared living. Track expenses, organize chores, and
              manage debts effortlessly in one unified space.
            </p>
            <div className="flex flex-col sm:flex-row w-full gap-sm mt-md">
              <button className="w-full sm:w-auto px-8 h-[48px] bg-primary text-on-primary rounded-[12px] font-label-md text-label-md btn-press transition-all shadow-level-1 flex items-center justify-center fade-in-up-element stagger-4 tactile-widget">
                Get Started
              </button>
